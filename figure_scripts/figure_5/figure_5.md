...
<img src="figure_5_files/figure-markdown_github/rand_func-1.png" width="672" />

``` python
import matplotlib.pyplot as plt
import seaborn as sns

MNP_harmonized = pg.read_input("/home/nealpsmith/projects/medoff/data/myeloid_harmonized.h5ad")
...
``` python
MNP_harmonized.obs["umap_1"] = MNP_harmonized.obsm["X_umap"][:, 0]
MNP_harmonized.obs["umap_2"] = MNP_harmonized.obsm["X_umap"][:, 1]
MNP_harmonized.obs["new_clusters"] = MNP_harmonized.obs["leiden_labels"]
MNP_harmonized.obs["new_clusters"][MNP_harmonized.obs["new_clusters"] == "10"] = "1"

MNP_harmonized.obs["new_clusters"][
        ((MNP_harmonized.obs["umap_1"] > 5) & (MNP_harmonized.obs["umap_1"] < 6.5)) & (
                    (MNP_harmonized.obs["umap_2"] < -5) & (MNP_harmonized.obs["umap_2"] > -6.6))] = "10"
...
<img src="figure_5_files/figure-markdown_github/embedding_density-11.png" width="672" />
...
<img src="figure_5_files/figure-markdown_github/cell_info-13.png" width="672" />
...
![](figure_5_files/figure-markdown_github/diff_abund-15.png)
